...
<%
    ...
    } else if ("delete".equals(formError)) {
        saveMessage = "회원 탈퇴 중 오류가 발생했습니다.";
    }
                ...
                <div class="grid">
                    <section class="card card-pad">
                        ...
                        <div class="profile-photo">
                            ...
                            <div class="help-text">PNG 파일만 가능</div>
                        </div>
                    </section>
                    ...
                    <section class="card card-pad account-card">
                        ...
                        <button class="btn danger"
                                ...
                                onclick="return confirm('정말 회원 탈퇴하시겠습니까? 탈퇴 후 계정 정보가 삭제됩니다.');">
                            회원 탈퇴
                        </button>
                    </section>
                </div>
